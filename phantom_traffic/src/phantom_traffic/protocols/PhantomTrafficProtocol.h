...
#ifndef PHANTOMTRAFFICPROTOCOL_H_
#define PHANTOMTRAFFICPROTOCOL_H_
...
class PhantomTrafficProtocol : public veins::BaseApplLayer {
...
protected:
     ...
     * subclasses
     */
    void sendPhantomTrafficMessage(int destinationAddress);
     ...
     */
    virtual void messageReceived(PhantomTrafficBeacon* pkt, BaseFrame1609_4* unicast);
...
public:
    ...
    PhantomTrafficProtocol()
    {
        sendBeacon = nullptr;
        recordData = nullptr;
        usedGates = 0;
    }
    virtual ~PhantomTrafficProtocol();
...
#endif /* PHANTOMTRAFFICPROTOCOL_H_ */
